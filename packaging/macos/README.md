...
- Submission: `2e5cbcc0-112c-4948-bf50-5d528fd2e9a7`, **Waiting for Review**, resubmitted 15 September 2026 at 07:19 Singapore time with the same build after a metadata-only correction. The original submission was 13 September at 00:57 Singapore time; see [review history](../../docs/APPLE-REVIEW-HISTORY.md). Automatic release after approval is selected.
