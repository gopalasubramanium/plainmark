...
The primary Mac button links to the [public Mac App Store listing](https://apps.apple.com/app/plainmark-markdown-editor/id6811364319), verified on 17 September 2026 in the Singapore and US storefronts as version 0.4.0, free, with macOS 11.0 minimum. Apple’s approval and Ready for Distribution emails were received on 16 September. Use a plain link without campaign parameters or third-party badge scripts. Keep direct DMGs and Homebrew available as alternatives; do not relabel them as Store packages.
