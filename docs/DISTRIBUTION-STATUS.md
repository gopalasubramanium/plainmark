...
| Microsoft Store | **[Public listing live](https://apps.microsoft.com/detail/9pb6h8z02k0g)**, verified 13 September 2026. Product `9PB6H8Z02K0G`, Plainmark Markdown Editor, publisher Gopala Subramanium. Submitted x64 package version 0.4.0.0; submission `1152921505701877168`. Free pricing, IARC rating, screenshots, license and reviewer information were submitted | Verify installation and signature of the Store-delivered edition on Windows; retain the candidate test evidence and remaining coverage gaps |
