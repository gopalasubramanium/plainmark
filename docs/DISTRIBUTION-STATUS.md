...
Last updated: 13 September 2026. **[Microsoft Store is live](https://apps.microsoft.com/detail/9pb6h8z02k0g)** as Plainmark Markdown Editor, published by Gopala Subramanium. Direct GitHub downloads remain the v0.3.3 preview. Apple was last confirmed Waiting for Review; no public Apple, Flathub or Snap listing has been confirmed.

| Channel | Actual progress | Next required step |
| --- | --- | --- |
| Website / GitHub | Live at https://markdown.eksaar.com/ with Microsoft Store as the primary Windows route and v0.3.3 direct downloads | Keep signing status and download links accurate |
...
The Homebrew tap is maintained by Plainmark's publisher. It is not acceptance into Homebrew's central cask repository. Store sign-in and opening a registration page are not app submission or certification. The Microsoft Store link now points to a verified public listing; links for other stores will be added when their public listings exist.
