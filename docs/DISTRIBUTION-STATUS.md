...
| Mac App Store | App `6811364319`, Plainmark Markdown Editor, draft 0.4.0. DSA declaration, age rating, privacy, listing/review contact and free worldwide pricing saved. Both Store certificates/profile issued. Universal app and installer signed and locally verified | Resolve GPL/Apple license terms, finish sandbox workflow tests and screenshots, validate/upload the package and submit for review |
